...
const FirstSection = () => {
  return (
    <div className="flex flex-col space-y-20 md:flex-row md:space-y-0 mb-20 md:mb-0 mt-20 justify-between w-[88%]  h-full mx-auto ">
      <div className=" flex flex-col  text-left space-y-4 md:w-3/6 ">
        ...
        <p className="text-lg">
          ...
          architecto culpa omnis. Maiores quod adipisci nihil ea necessitatibus.
          Quasi recusandae iure maxime libero voluptas ab, optio cupiditate sed
          dolores voluptates!
        </p>
      ...
      <div className="w-[70%] md:w-3/6 grid grid-cols-2 grid-rows-4 h-56 ">
        <div
          className="rounded-full z-10  border-2 border-cyan-500
            w-[350px] h-[350px] p-1 shadow-md m-auto
            shadow-violet-500/100 col-start-0 md:col-start-2"
        ></div>
        <div
          className="rounded-full z-30 bg-gradient-to-r from-violet-500 to-cyan-500 
            w-44 h-44 shadow-md shadow-cyan-500/100 col-start-2 sm:row-start-1"
        >
          <img
            src={profile_pic}
            alt="not found"
